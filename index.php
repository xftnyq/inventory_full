<?php 
// Redirect to login.php if the page is accessed directly
header("Location: login.php");
exit;  // Ensure the rest of the code doesn't run after redirect

// Your original PHP code (which won't run because of the redirect)
include 'header.php'; 
